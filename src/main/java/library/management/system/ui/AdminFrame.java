...
public class AdminFrame extends JFrame implements ActionListener {
    ...
    private String loggedInUsername; // Stored username of the logged-in user

    AdminFrame(JFrame loginFrame, String loggedInUsername) {
        ...
        JLabel adminLabel = new JLabel(loggedInUsername);
        try {
